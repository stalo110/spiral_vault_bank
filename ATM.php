          ...
          <div class="col-md-6 hidden-sm hidden-xs">
            <div class="left-content">
              <div class="section-half-thumb">
                <img src="main/images/partnership/Interex%20Finance-atm.jpg" class="img-responsive" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div>
              ...
              as long as you see the MasterCard® logo on it. </p>
				  ...
				  <ul style="margin-top: 20px;">
					...
					<br>
					<a href="about.php" class="button button-5x covered_but text_white control-btn-text" style="background-color: d51709 !important; font-size: 14px !important;">
							ATM Locator
							</a>
            </div>
          </div>
