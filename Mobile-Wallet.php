...
<!-- Mirrored from citizentrustonlinebk.com/Mobile-Wallet.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jan 2021 02:02:36 GMT -->
                    ...
                    <div class="col-sm-6">
                        <div class="nav-top-social">
                            <ul>
                                ...
                                <li style="color:white"><a style="color:white !important" href="contact-us.html"><i style="color:white" class="fa fa-envelope" aria-hidden="true"></i> contact@citizentrustonlinebk.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 ">
        ...
        <nav class="navbar navbar-flexo" id="coloo"  >
            <div class="" >
                <div class="navbar-header" >
                    ...
                    <a class="navbar-brand" href="index-2.php" style="width:100px; height:10px;">
					...
					<div class="row">
					  <div class="col-md-10 col-md-offset-1" style="margin-top: 40px;">
						<div class="section-heading text-left">
							...
							<p class="subtext"><b>Introducing Mobile Wallet, a safe and easy way to make payments with your Citizen Trust Online Bank's Debit and Credit Cards.</b>
 </p>
						</div>
					  </div>
					</div>
          ...
          <div class="col-md-12">
			  ...
			  <div class="col-md-10 col-md-offset-1">
                ...
                <p>To learn more about Mobile Wallet, like how to set up and use it, click the links below. Set up your HawaiiUSA Debit MasterCard® today!</p>
					...
					<p></p>
				  <p class="subtext">
				  	<a href="register-2.php" class="button button-2x primary-bg button-arrow button-radius">Apply Now &nbsp; &nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></a>
				  </p>
...
<div class="container-fluid">
   ...
   <div class="holdBottom hidden-md hidden-sm hidden-lg">
    	<div class="down_button1 text-center">
    		<a href="contact-us-2.php" class="text_white text-center no_text_deco no_color_on_hover" style=" width: 100%; height: 100%;"><i class="fa fa-envelope text_white"></i>&nbsp; Contact Us</a>
    	</div>
    	<div class="up_button text-center"><a style="width: 100%; height: 100%;" class="text_white no_text_deco no_color_on_hover" href="login-2.php" onClick="callSignInModal()">LOG IN</a></div>
    	<div class="down_button2 text-center"><a style="width: 100%; height: 100%;" class="no_color_on_hover text_white no_text_deco" target="_blank" href="register-2.php">OPEN ACCOUNT</a></div>
    </div>
    
    
    <div class="control-side hidden hidden-xs">
    	<div class="down_button1 text-center" style="width: 100%; background-color: #98C838;">
    		<a style="width: 100%; height: 100%; line-height:70px;" class="text_white no_text_deco no_color_on_hover" href="login-2.php" onClick="callSignInModal()">
    			<i class="fa fa-user text_white"></i>&nbsp;Login
    		</a>
    	</div>
    	<div class="upp_button text-center" style="background: #39A0ED; ">
    		<a target="_blank" href="register-2.php" class="text_white text-center no_text_deco no_color_on_hover" style=" width: 100%; height: 100%; line-height:70px;">
    			<i class="fa fa-check-circle-o text_white"></i>&nbsp; Open Account</a>
    	</div>
    </div>
    
    
    <div id="regModal" class="my_modal hideModal rubberBand wow " style="background:url(images/xbg_reg.jpg.pagespeed.ic.ufPUIaGYX7-2.php);background-repeat:no-repeat;background-size:cover">  
    	...
    	<div class="row theModalBody">
    		...
    		<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 text-center" style="margin-top: 10px;">
    			<a href="register-2.php" id="tradeControl" onClick="loadNext()" class="button button-4x covered_but round_but no_color_on_hover">Enroll</a>
    		</div>
   ...
   <div id="signInModal" class="my_modal2 hideModal " style="background:url(images/slider/xmobile_slider.png.pagespeed.ic.3nqiv0B8PA-2.php);background-repeat:no-repeat;background-size:cover">  
    	...
    	<div class="row">
    		<div class="col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-2 col-xs-offset-5 text-center control-mouse1">
    			<img src="images/slider/xlock-open.png.pagespeed.ic.AoSbGasDJO-2.php" class="img-responsive" data-pagespeed-url-hash="504164648" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
    		</div>
    		<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1" style="margin-top: 20px;">
    			<div class="modal-body">
                    <div class="section-heading text-center text_white">
                      ...
                      <img src="images/modal/internet-banking.gif.pagespeed.ce.zSYV8PG9gk-2.php" class="img-responsive" alt="" data-pagespeed-url-hash="1711300709" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                    </div>
    		...
    		<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 text-center" style="margin-top: 10px;">
    			<a target="_blank" href="login-2.php" class="button button-4x covered_but round_but no_color_on_hover">LOGIN</a>
    		</div>
    		...
    		<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 text-center text_white" style="margin-top: 10px;">
    			Not Yet Registered?<br><a href="register-2.php" onClick="callRegModal()" class="no_color_on_hover" style="text-decoration: underline;">Enroll Now!</a>
    		</div>
       ...
       <div id="forGetPass" class="my_modal2 hideModal " style="background:url(images/slider/xmobile_slider.png.pagespeed.ic.3nqiv0B8PA-2.php);background-repeat:no-repeat;background-size:cover">  
    	...
    	<div class="row">
    		...
    		<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 text-center" style="margin-top: 10px;">
    			<a href="login-2.php" onClick="callSignInModal()" class="no_color_on_hover">Login</a>
    		</div>
            ...
            <div class="text-center col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
              <aside class="widget widget-content">
                <div class="widget-body">
                  <div class="my-link">
                    <ul >
                        <li ><a href="index-2.php" class="text_white">Home</a></li>
      ...
      <div class="footer-copyright">
        <div class="container">
          <div class="row">
            <div class="col-sm-6">
              <div class="copyright">
                <p> <a href="main/index.php#">Citizen Trust Online Bank.</a> © All rights reserved.</p>
...
<!-- Mirrored from citizentrustonlinebk.com/Mobile-Wallet.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Jan 2021 02:02:45 GMT -->
</html>
