    ...
    <div class="container-fluid">
      <div class="row">
      		<div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#d51709; ">
				<img src="main/images/partnership/cpa-af-bg.jpg" style="width: 100%; height: 100%;" data-pagespeed-url-hash="4011159537" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="right-content">
                <img src="main/images/about/image-content-1_1.jpg" class="img-responsive" alt="" data-pagespeed-url-hash="3640630981" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
            </div>
          </div>
        </div>
      </div>
...
<div class="container-fluid">
   ...
   <div class="holdBottom hidden-md hidden-sm hidden-lg">
    ...
    <div id="regModal" class="my_modal hideModal rubberBand wow " style="background:url(images/xbg_reg.jpg.pagespeed.ic.ufPUIaGYX7.php);background-repeat:no-repeat;background-size:cover">  
   ...
   <div id="signInModal" class="my_modal2 hideModal " style="background:url(images/slider/xmobile_slider.png.pagespeed.ic.3nqiv0B8PA.php);background-repeat:no-repeat;background-size:cover">  
    	...
    	<div class="row">
    		<div class="col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-2 col-xs-offset-5 text-center control-mouse1">
    			<img src="images/slider/xlock-open.png.pagespeed.ic.AoSbGasDJO.php" class="img-responsive" data-pagespeed-url-hash="504164648" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
    		</div>
    		<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1" style="margin-top: 20px;">
    			<div class="modal-body">
                    <div class="section-heading text-center text_white">
                      ...
                      <img src="images/modal/internet-banking.gif.pagespeed.ce.zSYV8PG9gk.php" class="img-responsive" alt="" data-pagespeed-url-hash="1711300709" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
                    </div>
       ...
       <div id="forGetPass" class="my_modal2 hideModal " style="background:url(images/slider/xmobile_slider.png.pagespeed.ic.3nqiv0B8PA.php);background-repeat:no-repeat;background-size:cover">  
