        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">All Verified Customer Data</h6>
              <?php
              ...
              if(strpos($url, "mail=welcome")==true){
                echo "<h3 style='color:4e73df'>WELCOME ADMIN..</h3>";
              }
