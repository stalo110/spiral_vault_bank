    ...
    <header style=" background-image: url(img/bck.jpg);
      ...
      <div class="row">
      		<div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#d51709; ">
				<img src="main/images/Prepaid%20Card/prepaid-card.png" style="width: 100%; height: 100%;">
				<div class="holdWriteUp">
					<h3 class="text-center carryTop text_white">
						Online Banking
					</h3>
					<p class="text-center carryBottom text_white">
                When it comes to managing your personal or business accounts, you'll be able to quickly pay bills, transfer money, apply for certain loans and much more through The Spiral Vault Online Bank's Online Banking.
					</p>
            ...
            <div class="row">
            	<div class="col-md-10 col-md-offset-1 text-left">
					...
					<ul style="margin-top: 20px;">
						...
						<li dir="LTR">&#8226;<strong>&nbsp;</strong>Transfer funds between your The Spiral Vault Online Bank and outside accounts</li>
        ...
        <div class="row">
          <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12">
            <div class="section-heading text-center">
				<h3 class="title">Key<span style="color: #d51709;"> Benefits</span></h3>
           ...
           <div class="row" >
				<div class="col-md-6 col-sm-6">
				  <div  style="background: transparent;">
					<div class="feature-box text-center">
					  <h6 class="title" style="color: #d51709;">Automatic Payments</h6>
					  <p class="subtext">Stop worrying over lost or late payments. Be confident it gets there on-time, every time with Automatic Payments from The Spiral Vault Online Bank's Online Banking.</p>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
				  <div class="feature-box-4-grid1 "  style="background: transparent;">
					<div class="feature-box text-center">
					  <h6 class="title" style="color: #d51709;">Online Bill Pay</h6>
           	...
           	<div class="row" >
				<div class="col-md-6 col-sm-6 col-xs-12">
				  <div class="feature-box-4-grid1" style="background: transparent;">
					<div class="feature-box text-center">
					  <h6 class="title" style="color: #d51709;">eAlerts</h6>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
				  <div class="feature-box-4-grid1" style="background: transparent;">
					<div class="feature-box text-center">
					  <h6 class="title" style="color: #d51709;">eStatements </h6>
    ...
    <div id="regModal" class="my_modal hideModal rubberBand wow " style="background: url( images/bg_reg.php); background-repeat: no-repeat; background-size: cover;">  
    	...
    	<div class="row theModalBody">
    		<div class="col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-4 col-xs-offset-4 text-center control-mouse" >
    			<img src="images/slider/theMouse.php" class="img-responsive">
    		</div>
   ...
   <div id="signInModal" class="my_modal2 hideModal " style="background: url(images/slider/mobile_slider.php); background-repeat: no-repeat; background-size: cover;">  
    	...
    	<div class="row">
    		<div class="col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-2 col-xs-offset-5 text-center control-mouse1" >
    			<img src="images/slider/lock-open.php" class="img-responsive">
    		</div>
    		<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1" style="margin-top: 20px;">
    			<div class="modal-body">
                    <div class="section-heading text-center text_white">
                      ...
                      <img src="images/modal/internet-banking.php" class="img-responsive" alt="">
                    </div>
       ...
       <div id="forGetPass" class="my_modal2 hideModal " style="background: url(images/slider/mobile_slider.php); background-repeat: no-repeat; background-size: cover;">  
    	...
    	<div class="row">
    		<div class="col-md-2 col-md-offset-5 col-sm-4 col-sm-offset-4 col-xs-2 col-xs-offset-5 text-center control-mouse1" >
    			<img src="images/slider/frgtPass.php" class="img-responsive">
    		</div>
