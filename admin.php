            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="scripts/adminlogin.php">
                  <?php
               
               $url = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
              
              if(strpos($url, "mail=success")==true){
                echo "<p style='color:red'>Your Application successful login to your account..</p>";
              }
              if(strpos($url, "mail=invalid")==true){
               ...
               ?>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="uid"  placeholder="Enter Account Name...">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="pwd" placeholder="Password">
                    </div>
