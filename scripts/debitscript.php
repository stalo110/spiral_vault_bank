...
$message.=  "<img src='https://www.onochltd.com/logo.png'>";

$message.=  "<h1 style='padding: 1px;font-family: Georgia;'><span style='color:rgb(253, 150, 26);'>Onoch </span> Limited</h1>";
...
$message.=  "<tr><td><strong>Credit/Debit</strong>: </td><td>  Debit   </td></tr>";
$message.= "<tr><td><strong>Account Name</strong>: </td><td>".$acctna. "</td></tr>";
$message.=  "<tr><td><strong>Account Number</strong>: </td><td>  ".$acctnumb. "</td></tr>";
...
$message .=  "<p style='text-align:center;'><span style='color:rgb(253, 150, 26);'>Onoch </span> Limited  © 2020 All Rights Reserved</p> ";
...
$message.=  "</body></html>";
        ...
        header("Location:../op.php?debit=success");
		exit();
