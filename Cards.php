...
<head>
    ...
    <title>Home | info@thespiralvault.com</title>
    <!-- Bootstrap -->
            ...
            <div class="" >
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right" >
                        ...
                        <li class="dropdown">
                            <a href="#" style="color: white;">info@thespiralvault.com</a>
                            <ul class="dropdown-menu">
     ...
     <div class="container-fluid">
      <div class="row">
      		<div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#d51709; ">
                ...
                info@thespiralvault.com makes digital payments and transfers easy with various credit, debit and ATM card options to suit your needs. You'll appreciate the anytime access and other convenient features of these cards.
					</p>
           ...
           <div class="row" >
				<div class="col-md-6 col-sm-6">
				  <div  style="background: transparent;">
					<div class="feature-box text-center">
					  <h6 class="title" style="color: #d51709;">Credit Cards</h6>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
				  <div class="feature-box-4-grid1 "  style="background: transparent;">
					<div class="feature-box text-center">
					  <h6 class="title" style="color: #d51709;">Debit Cards</h6>
					  <p class="subtext">Your info@thespiralvault.com personal checking account includes one of our feature-rich Debit MasterCard® options. </p>
           	...
           	<div class="row" >
				<div class="col-md-6 col-sm-6 col-xs-12">
				  <div class="feature-box-4-grid1" style="background: transparent;">
					<div class="feature-box text-center">
					  <h6 class="title" style="color: #d51709;">ATM Cards</h6>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
				  <div class="feature-box-4-grid1" style="background: transparent;">
					<div class="feature-box text-center">
					  <h6 class="title" style="color: #d51709;">Mobile Wallet</h6>
      ...
      <div class="footer-copyright">
        <div class="container">
          <div class="row">
            <div class="col-sm-6">
              <div class="copyright">
                <p> <a href="main/index.php#">info@thespiralvault.com.</a> © All rights reserved.</p>
