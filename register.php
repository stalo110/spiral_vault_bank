...
<div class="container-fluid" style=" padding-right:0px; padding-left:0px;">
                    ...
                    <div class="col-sm-6">
                        <div class="nav-top-social">
                            <ul>
                                ...
                                <li style="color:white"><a style="color:white !important" href="contact-us.html"><i style="color:white" class="fa fa-envelope" aria-hidden="true"></i> info@thespiralvault.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 ">
          ...
          <div class="col-md-8 col-md-offset-2">
            <div>
              ...
              <div class="col-xs-12 col-sm-12 col-lg-12" style="margin-top: 10px;">                                   
                            <form method="POST" enctype="multipart/form-data" onsubmit="return change_psw()"  action="https://thespiralvault.com/scripts/userregisterscript.php">
                                <div class="col-xs-12 col-sm-12 col-lg-12" style="margin-top: 10px;">                                </div>
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon">
                                            <i class="fa fa-user" style="color:#d51709;"></i>                                      </span>
                                            <input type="text" class="form-control" name="acctname" id="first_name" placeholder="Enter Full Name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon" id="basic-addon1">
                                            <i class="fa fa-user" style="color:#d51709;"></i>                                          </span>
                                            <input type="text" value="" name="username" id="username" class="form-control" placeholder="Enter Username" required>
                                        </div>
                              </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon" id="basic-addon1">
                                            <i class="fa fa-globe" style="color:#d51709;"></i>                                          </span>
                                            <select  name="nation" id="nationality" style="border:#D3CACA solid 1px; border-radius:0px;"  class="form-control">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon">
                                            <i class="fa fa-envelope" style="color:#d51709;"></i>                                          </span>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon">
                                            <i class="fa fa-map-marker" style="color:#d51709;"></i>                                          </span>
                                            <input type="text" required name="addr" id="address" class="form-control" placeholder="Address">
                                        </div>
                              </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon">
                                            <i class="fa fa-phone" style="color:#d51709;"></i>                                          </span>
                                            <input type="text" value="" id="phone_no" required name="tel" class="form-control" placeholder="Telephone">
                                        </div>
                                  ...
                                  <div class="row"  style=" position:absolute;  ">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon">
                                            <i class="fa fa-calendar" style="color:#d51709;"></i>                                          </span>
                                            <input type="date" required id="dob" name="birth" class="form-control" placeholder="Date of Birth" aria-describedby="basic-addon1">
                                        </div>
                              </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon">
                                            <i class="fa fa-user" style="color:#d51709;"></i>                                          
                                          </span>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon">
                                            <i class="fa fa-key" style="color:#d51709;"></i>                                          
                                          </span>
                                            <input type="password" id="psw" required name="pwd" class="form-control" placeholder="Enter Password">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon" id="basic-addon1">
                                            ...
                                            <input type="password" id="re_psw" required name="pin" class="form-control" placeholder="Enter Pin">
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon" id="basic-addon1">
                                            <i class="fa fa-tags" style="color:#d51709;"></i>                                          </span>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-lg-6" style="margin-top: 10px;">
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon" id="basic-addon1">
                                            <i class="fa fa-briefcase" style="color:#d51709;"></i>                                          </span>
                                            <select name="accttype" class="form-control" id="account_type" required>
 ...
 <br>
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-addon" id="basic-addon1">
                                            <i class="fa fa-user-circle" style="color:#d51709;"></i>                                          </span>
                                            <input type="file" name="img" id="photo" required class="form-control" />
                                        </div>
                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-lg-8 col-lg-offset-2 text-center" style="margin-top: 20px;">
                        <button type="submit" name="userregister" id="register" class="button button-4x covered_but text_white" style="background-color:#336699;">Submit</button>
                </div>
