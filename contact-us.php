...
<div class="container-fluid" style=" padding-right:0px; padding-left:0px;">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#d51709; ">
                <img src="main/images/contact/trade4plus-contact-us-bg.jpg" class="manage-image-height">
                <div class="contact-write">
                    ...
                    <div class="col-md-4 handle-logo">
                        ...
                        <!-- <div class="col-md-12 text_white" style="margin-top: 20px">
                            ...
                            <p style="width: 100%;"><strong>Phone: </strong>+ 1(951) 572-2637</p>
                        </div> -->
                    </div>
                    ...
                    <?php
                   $sql = "SELECT address FROM settings WHERE id = 1";
				...
				<span class="text_white" style="display: inline-block">
					&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                            ...
                                            <!-- <p style="color: #fff">2750 Broad St San Luis Obispo, California 93401, USA</p> -->
						  	</span>		
                        <div class="col-md-12 text_white" style="margin-top: 10px">
                            <h6 style="width: 100%; ">Marketing Team</h6>
                            <p style="width: 100%;"><strong>Email: </strong>info@thespiralvault.com</p>
                        </div>
                    </div>
                    ...
                    <div class="handle-logo3">
                        ...
                        <div class="col-md-12 text_white" style="margin-top: 20px">
                            <h6 style="width: 100%; ">Partnership Team</h6>
                            <p style="width: 100%;"><strong>Email: </strong>info@thespiralvault.com</p>
                        </div>
                    </div>
                </div>
    ...
    <!-- Info Box -->
    <div class="container-fluid">
        <div id="theNext" class="info-box section-padding-me row" style="background: url(main/images/security/security__info-bg.png); background-repeat: no-repeat; background-size: 100% 100%; padding-top:0px; padding-bottom:50px;">
            <div class="container" >
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-md-offset-3" style="margin-top:20px;">
                                <div class="section-heading text-center">
                                    <h3 class="title" style="color:#d51709; ">We offer support in the <span style="color:#E3AF15;">following areas:</span></h3>
                     ...
                     <div class="col-md-12">
                         <div class="col-md-7" style="margin-top: 20px;">
                                ...
                                <img src="main/images/template/contact_bg.jpg" class="image-responsive">
                                ...
                                <div class="white-board">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-9 col-xs-12 " >
                                            <div class="row">
                                                <h6 class="col-md-12" style="color:#d51709; ">
    ...
    <!-- About -->
    <div class="container-fluid">
        <div class="about section-padding-me row" style="/*background:url(main/images/slider/invest.jpg); background-repeat: no-repeat; background-size: cover;*/">
            <div class="container">
                <!--<div class="row">
                    ...
                    <div class="col-sm-12 control-sides" style="" id="two-factor">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 hidden-xs">
                                <!-- <img src="main/images/contact/multi-lang.png" class="img-responsive"> -->
                            </div>
                            <div class="col-md-6 ">

                                <div class="section-heading text-center">
                                    <h3 class="title" style="text-align: left;">We speak your <span style="color: #d51709;"> language</span></h3>
                                    <img src="main/images/contact/multi-lang.png" class="img-responsive hidden-sm hidden-md hidden-lg">
    ...
    <!-- Service -->
    <div class="container-fluid">
        <div class="service section-padding row" style="background:#f2f5fb; background:url(main/images/slider/invest.jpg); background-repeat: no-repeat; background-size: cover;">
            <div class="container">
                <div class="row">
