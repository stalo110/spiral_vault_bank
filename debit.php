...
include 'adminhead.php';
                                   ...
                                   <div class='col-lg-7'>
                                     <div class='p-5'>
                                       <div class='text-center'>
                                         <h1 class='h4 text-gray-900 mb-4'>Debit Customer....</h1>
                                         
                                       </div>
                        <form action='scripts/debitscript.php' method='POST' class='user'>
	...
	<input type='text' class='form-control form-control-user' name='acctnumb' value='$accttype'>
            ...
            <input type='text' class='form-control form-control-user' name='amoun' placeholder='Enter Amount'> 
							...
							<input type='hidden' name='acctbal' value='$acctba'> 

							<input type='submit' name='debit' value='DEBIT' class='btn btn-success'>
