    ...
    <div class="container-fluid">
      <div class="row">
      		<div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#d51709; ">
				<img src="main/images/partnership/cpa-af-bg.jpg" style="width: 100%; height: 100%;">
				<div class="holdWriteUp">
					<h3 class="text-center carryTop text_white">
						Wealth Management
					</h3>
					<p class="text-center carryBottom text_white">
						 Straight forward banking services, planning, investment solutions, <br>and financing options.
					</p>
				</div>
		  	</div>
      </div>
            ...
            <div class="right-content">
              <div class="image-content image-content-3">
                <div class="section-heading">
                  <h3 class="title my-title" style="color:#d51709; margin-bottom: 20px; ">With great <span style="color:#E3AF15;">wealth </span> comes great <span style="color:#E3AF15;">responsibility </span></h3>
      ...
      <div class="footer-copyright">
        <div class="container">
          <div class="row">
            <div class="col-sm-6">
              <div class="copyright">
                <p> <a href="main/index.php#">Cadence Partner plc.</a> © All rights reserved.</p>
