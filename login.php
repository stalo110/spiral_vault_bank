						...
						<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-keyboard="false" data-backdrop="static" aria-hidden="true">
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header" style="background-color:#d51709;">
						      ...
						      <div class="modal-body">
						        <div class="row">
										...
										<div style="color:#d51709; " class="col-md-12 col-sm-12" id="result">										</div>
										<div class="col-md-12 col-sm-12" id="showData">
											<div class="input-group">
											  <span class="input-group-addon" id="basic-addon1">
												<i class="glyphicon glyphicon-envelope" style="color:#d51709;"></i>											  </span>
